...
void draw() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    bus.sendControllerChange(0, 20, round(handPosition.x*127/500));
    bus.sendControllerChange(0, 21, round((500-handPosition.y)*127/500));
    
    
    //println(round(handPosition.y*127/500));
    
    
    //if (wait_counter > handPosition.x*80/500) {
    //  pitch = round(handPosition.y*127/500);
    //  println(pitch);
    //  bus.sendNoteOn(0, pitch, 100);
    //  wait_counter = 0;
    //}
    //else{
